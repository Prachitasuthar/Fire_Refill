...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-secondary navbar-dark sticky-top py-2 px-lg-5 wow fadeIn"
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="#" class="nav-item nav-link py-2">Home</a>
                ...
                @auth
                    ...
                    <div class="nav-item dropdown">
                        <a href="{{ route('profile') }}" class="nav-link dropdown-toggle py-2 active py-2 px-lg-2"
    ...
    <div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
        <div class="card w-50 shadow-sm p-4">
            <h2 class="mb-4" style="color: #666666">Change Password</h2>
