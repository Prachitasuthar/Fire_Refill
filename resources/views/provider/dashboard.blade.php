                            ...
                            <div class="card-body">
                                <ul class="list-group custom-list-group">
                                    <li class="list-group-item align-items-center d-flex justify-content-between">
                                        <div class="media">
                                            <img src="{{ asset('hotel/images/small/rgb.svg') }}" height="30"
                                    ...
                                    <li class="list-group-item align-items-center d-flex justify-content-between">
                                        <div class="media">
                                            <img src="{{ asset('hotel/images/small/cobweb.svg') }}" height="30"
                                                class="me-3 align-self-center rounded" alt="...">
                                            <div class="media-body align-self-center">
                                    ...
                                    <li class="list-group-item align-items-center d-flex justify-content-between">
                                        <div class="media">
                                            <img src="{{ asset('hotel/images/small/blocks.svg') }}" height="30"
                                                class="me-3 align-self-center rounded" alt="...">
                                            <div class="media-body align-self-center">
                                    ...
                                    <li class="list-group-item align-items-center d-flex justify-content-between">
                                        <div class="media">
                                            <img src="{{ asset('hotel/images/small/atom.svg') }}" height="30"
                                                class="me-3 align-self-center rounded" alt="...">
                                            <div class="media-body align-self-center">
                            ...
                            <div class="card-bodyp-0">
                                <div class="p-3" data-simplebar style="height: 400px;">
                                    <div class="activity">
                                        ...
                                        <div class="activity-info">
                                            <div class="icon-info-activity">
                                                <img src="{{ asset('hotel/images/users/user-5.jpg') }}" alt=""
                                        ...
                                        <div class="activity-info">
                                            <div class="icon-info-activity">
                                                <img src="{{ asset('hotel/images/users/user-4.jpg') }}" alt=""
                                                    class="rounded-circle thumb-sm">
                                            </div>
                                            <div class="activity-info-text">
                                                <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="card-body">
                                <div class="table-responsive browser_users">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><img src="{{ asset('hotel') }}/images/logos/chrome.png" alt=""
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('hotel/images/logos/micro-edge.png') }}"
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('hotel/images/logos/in-explorer.png') }}"
                                                        alt="" height="16" class="me-2">Internet-Explorer
                                                </td>
                                                <td>1836<small class="text-muted">(38%)</small></td>
                                                <td> 41.12%</td>
                                                <td>455<small class="text-muted">(74%)</small></td>
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('hotel/images/logos/opera.png') }}" alt=""
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('hotel/images/logos/chrome.png') }}"
